...
\begin{itemize}
	...
	\begin{itemize}
		...
		\\
		Just in case:
		\item block traffic to h4.
		\item block traffic to subnet 1.
		\item block traffic to subnet 3.
	\end{itemize}
	...
	\end{tabular}}
	\begin{itemize}
		\item explicily only allow UDP traffic from h1 to h3.   
		\\\\
		Just in case:
		\item block traffic to h4 
		\item block TCP traffic
		\item block incoming traffic from h2,h3,h4,h5,h6 
	\end{itemize}
\end{itemize}
\end{document}
